...
applications can access the Providing Application using the [discover context availability operation](walkthrough_apiv1.md#discover-context-availability-operation) and do
